    ...
    _createClass(DashBoard, [{
        ...
        value: function componentDidMount() {
            ...
            firebaseFilter.on("value", function (snapshot) {
                ...
                if (Sensor[0].status === 'Alert' || Sensor[0].status === 'alert' || Sensor[1].status === 'Alert' || Sensor[1].status === 'alert' || Sensor[2].status === 'Alert' || Sensor[2].status === 'alert' || Sensor[3].status === 'Alert' || Sensor[3].status === 'alert') {
                    var Sound = document.getElementById("Sound");
                    Sound.autoplay = true;
                    Sound.load();
                }
                for (var i = 0; i <= Sensor[i].length; i++) {
...
//# sourceMappingURL=3.da40b2b0c9f74028024f.hot-update.js.map