        ...
        value: function componentDidMount() {
            ...
            firebaseFilter.on("value", function (snapshot) {
                ...
                for (var i = 0; i < Sensor.status.length; i++) {
                    if (Sensor[i].status === 'Alert' || Sensor[i].status === 'alert' || Sensor[i].status === 'Error' || Sensor[i].status === 'error' || Sensor[i].value > 100) {
                        var Sound = document.getElementById("Sound");
                        Sound.autoplay = true;
                        Sound.load();
                        notificationAlert();
                    }
                    console.log(Sensor[i].value);
                }
            });
...
//# sourceMappingURL=4.81cbd94858a8fa21c96b.hot-update.js.map